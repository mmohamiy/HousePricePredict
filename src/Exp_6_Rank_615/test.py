...
model_xgb = CustomEnsembleRegressor([xgb1,xgb2,xgb3])


stacked_averaged_models = AveragingModels(models = (ENet, model_xgb, model_lgb,GBoost,lasso))
...
# Ensembling result ...
Ensemble_Result = GBoost_pred*0.10 + stacked_pred*0.90
