...
ridge_model = make_pipeline(RobustScaler(), Ridge(alpha=0.005))
"""
...
"""
stacked_averaged_models = AveragingModels(models = (model_xgb, lasso, model_lgb, ridge_model))
stacked_averaged_models.fit(train.values, y_train)
stacked_train_pred = stacked_averaged_models.predict(train.values)
stacked_pred = np.expm1(stacked_averaged_models.predict(test.values))
print("StackedAverageModels: " + str(rmsle(y_train, stacked_train_pred)) )
"""
...
# Ensembling result ...
Ensemble_Result = stacked_pred*0.70 + xgb_pred*0.15 + lgb_pred*0.15
