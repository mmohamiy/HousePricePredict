...
Global_Data['TotalSeqFeet'] = (Global_Data['GrLivArea'] - Global_Data['TotalBsmtSF'] )+ \
                          Global_Data['TotalBsmtSF'] + Global_Data['1stFlrSF'] + Global_Data['2ndFlrSF']
...
Let's see which the importance of features, using XGBoost Model ...
"""
...
stacked_averaged_models = StackingAveragedModels(base_models = (ENet, model_lgb, model_xgb),
                                                 meta_model = GBoost)


#stacked_averaged_models = AveragingModels(models = (ENet, model_xgb, model_lgb,lasso))
...
# Ensembling result ...
Ensemble_Result = GBoost_pred*0.30 + stacked_pred*0.70
